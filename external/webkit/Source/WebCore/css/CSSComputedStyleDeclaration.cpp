...
static const int computedProperties[] = {
    ...
    CSSPropertyBackfaceVisibility,// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
    ...
    CSSPropertyPerspective,// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
    CSSPropertyPerspectiveOrigin,// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
    ...
    CSSPropertyTop,
    CSSPropertyTransform,// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
    CSSPropertyTransformOrigin,// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
    CSSPropertyTransformStyle,// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
...
PassRefPtr<CSSValue> CSSComputedStyleDeclaration::getPropertyCSSValue(int propertyID, EUpdateLayout updateLayout) const
{
    ...
    switch (static_cast<CSSPropertyID>(propertyID)) {
	 ...
	 case CSSPropertyBackfaceVisibility://// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
	 ...
	 case CSSPropertyPerspective://// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
        case CSSPropertyWebkitPerspective:
            if (!style->hasPerspective())
                return primitiveValueCache->createIdentifierValue(CSSValueNone);
            return primitiveValueCache->createValue(style->perspective(), CSSPrimitiveValue::CSS_NUMBER);
	 case CSSPropertyPerspectiveOrigin://// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
	 ...
	 case CSSPropertyTransform:// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
        case CSSPropertyWebkitTransform:
            return computedTransform(renderer, style.get(), primitiveValueCache);
	 case CSSPropertyTransformOrigin:// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
        ...
        case CSSPropertyTransformStyle:// SAMSUNG CHANGE : CSS3 2D Transforms, Standard
